...
gdsdk= function() {
  ...
  this.showAd= function (adType) {
    ...
    if (adType== "rewarded") {
      return new Promise((resolve, reject)=> {
        loadJS("https://www.play.gmg-studio.com/ads/rewarded.js", (success)=> {
        if (success) {
      ...
      return new Promise((resolve, reject)=> {
        loadJS("https://www.play.gmg-studio.com/ads/commercial.js", (success)=> {
          window.GD_OPTIONS.onEvent({
            name: "SDK_GAME_START",
            message: "No Message",
          });
...
op3n= function() {
  ...
  window.open("https://www.play.gmg-studio.com/");
  // alert("--fx--xopen--");
}